...
## Introduction
This vignette shows how to use package `survSpearman` to estimate Spearman's correlation between two time-to-event variables. It also demonstrates some basic tools for visualizing bivariate survival data.
...
Finally, let's plot a conditional PDF within the threstricted region $[0, 1.4) \times [0, 1.4)$,
